...
- **Seizure Fundamentals** - Definitions, semiology, and classification
...
- Gene-specific treatment tables
- Emergency medication guidance (especially for Dravet syndrome)

## Quick Links

### Essential Resources
- [ILAE Classification Portal](https://www.ilae.org/guidelines/definition-and-classification)
...
```bash
git clone https://github.com/ykshim2013/PED_Neuro_seizure.git
```
